...
from game.utils.constants import DRILL_BULLET, DRILL_BULLET_TYPE, SCREEN_WIDTH, SCREEN_HEIGHT


class DrillBullet(PowerUp):
    MOV_X = {0: 'left', 1: 'right'}

    def __init__(self, move_x_for = [30, 100]):
      super().__init__(DRILL_BULLET, DRILL_BULLET_TYPE) 
